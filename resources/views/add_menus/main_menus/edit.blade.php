                    ...
                    <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12 ">
                        <div class="card">
                            <div class="card-body  table-new">
                                <form class="m-5" action="{{ route('menus.update',['menu' => $data->id]) }}" method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select @error('link_type') is-invalid @enderror" name="link_type" id="link_type">
                                            ...
                                            <option value="slug" {{ old('link_type', $data->link_type) == 'slug' ? 'selected' : '' }}>Slug</option>
                                            <option value="link" {{ old('link_type', $data->link_type) == 'link' ? 'selected' : '' }}>Link</option>
                                        </select>
                                        @error('link_type')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
