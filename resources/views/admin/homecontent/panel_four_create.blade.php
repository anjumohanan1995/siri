...
<div class="main-content app-content">
	...
	<div class="main-container container-fluid">
		...
		<div class="breadcrumb-header justify-content-between row me-0 ms-0 mb-3" >
			<div class="col-xl-3">
				<h4 class="content-title mb-2">Home Content(Panel 4) </h4>
				...
				<div class="col-lg-12 col-xl-12 col-md-12 col-sm-12 ">
					<div class="card">
							...
							<div class="card-body">
								...
								<form name="createForm"  method="post" action="{{route('panel_four.store')}}" enctype="multipart/form-data">
                           @csrf
									...
									<div class="form-group">
										...
										<div class="row">
											...
											<div class="col-md-9">
											    <input type="text" value="{{@$data->panel_four_title}}"  class="form-control" placeholder="Title " name="panel_four_title" />
                                    @error('panel_four_title')
                                    ...
                                    @enderror
										...
										<div class="row">
											...
											<div class="col-md-9"><textarea class="ckeditor form-control" placeholder=" Description" name="panel_four_description">{{ @$data->panel_four_description }}</textarea>
												@error('panel_four_description')
													<span class="text-danger">{{$message}}</span>
												@enderror
											</div>
										</div>
                                         ...
                                         <br>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-9">
                                                    ...
                                                    <input type="file" id="img_file" name="panel_four_image" class="form-control" accept=".png, .jpg, .jpeg"  onChange="img_pathUrl(this);"><br>
                                                   @if(@$data->panel_four_image != '')
                                                   <img src="{{ asset('homecontent/panel_four/' . $data->panel_four_image) }}" width="200px" height="160px" />
                                                    @endif
                                                    @error('panel_four_image')
                                                        <span class="text-danger">{{$message}}</span>
                                                    @enderror
                                                </div>
                                            </div>
