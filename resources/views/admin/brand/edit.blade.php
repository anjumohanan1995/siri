...
<div class="main-content app-content">
	...
	<div class="main-container container-fluid">
		...
		<div class="breadcrumb-header justify-content-between row me-0 ms-0 mb-3" >
			<div class="col-xl-3">
				<h4 class="content-title mb-2"> Edit Brand  </h4>
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb">

						<li class="breadcrumb-item active" aria-current="page"><i class="side-menu__icon fe fe-box"> </i> - Edit Brand </li>
					</ol>
				</nav>
			</div>
		</div>
                ...
                <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12 ">
					<div class="card">
							...
							<div class="card-body">
								...
								<form name="createForm"  method="post" action="{{ route('brands.update',$data->id) }}" enctype="multipart/form-data">
                                    	@csrf
                                        @method('PUT')
