                        ...
                        <ul class="side-menu" style="margin-right: 0px;">
                            ...
                            <li class="slide">
                                ...
                                <ul class="slide-menu">
                                    ...
                                    <li class="sub-slide">
                                        <a class="slide-item" data-bs-toggle="sub-slide" href="admin-verticals">
        ...
        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog">
                ...
                <div class="main-footer ht-45">
                    ...
                    <div class="container-fluid pd-t-0-f ht-100p">
                        <span>
                            Copyright © 2024 <a href="javascript:void(0);" class="text-primary"></a>. Designed with by
                            <a href="javascript:void(0);"> Kawika Technologies </a> All rights reserved.
                        </span>
                    </div>
                </div>
                <!-- Footer closed -->
            ...
            <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h1 class="modal-title fs-5" id="exampleModalLabel">Dilip Kumar (36) - Arogya kiranam
                            </h1>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"><svg
